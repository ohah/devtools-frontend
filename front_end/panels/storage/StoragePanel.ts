...
export class StoragePanel extends UI.Panel.PanelWithSidebar implements AsyncStorageStoragePanelContract {
...
export class AsyncStorageStoragePanel extends UI.Panel.PanelWithSidebar implements AsyncStorageStoragePanelContract {
  visibleView: UI.Widget.Widget|null;
  private pendingViewPromise: Promise<UI.Widget.Widget>|null;
  storageViews: HTMLElement;
  private readonly storageViewToolbar: UI.Toolbar.Toolbar;
